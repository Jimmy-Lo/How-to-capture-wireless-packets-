function networkData = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   NETWORKDATA = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   NETWORKDATA = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   networkData = importfile1('networkData.txt', 1, 19702);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/02/21 01:20:48
...
dataArray([3, 5]) = cellfun(@(x) num2cell(x), dataArray([3, 5]), 'UniformOutput', false);
networkData = [dataArray{1:end-1}];
