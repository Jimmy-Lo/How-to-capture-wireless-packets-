...
import org.pcap4j.packet.AbstractPppPacket.AbstractPppHeader;
import org.pcap4j.packet.PppPacket.Builder;
...
public final class IllegalPacket extends AbstractPacket {
  ...
  private final IllegalHeader header = null;
  ...
  @Override
  public IllegalHeader getHeader() {
    return header;
  }
  ...
  public static class IllegalHeader extends AbstractHeader{
